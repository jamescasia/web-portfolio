...
class AppData {
  static List<Project> projectList = [
    ...
    Project(
        ...
        videoPath: 'assets/gifs/picnic-panic.gif',
        playStoreLink:
    ...
    Project(
        ...
        videoPath: "assets/gifs/papyrus.gif",
    ...
    Project(
        ...
        videoPath: "assets/gifs/mentallerts.gif",
        miscLink:
    ...
    Project(
        ...
        videoPath: "assets/gifs/color-flex.gif",
        miscLink:
    ...
    Project(
        ...
        videoPath: "assets/gifs/mansana.gif",
    ...
    Project("PlantApp", "PlantApp is the Instagram/Pinterest for plants!",
        ...
        videoPath: "assets/gifs/plant-app.gif",
    ...
    Project("DengueLytics", "DengueLytics is a dengue tracking app.",
