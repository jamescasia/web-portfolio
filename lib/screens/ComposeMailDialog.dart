  ...
  Widget build(BuildContext context) {
    return Dialog(
      ...
      child: Container(
        ...
        padding: EdgeInsets.all(((Globals.width>Globals.height) ? Globals.dwidth: Globals.dheight) * 30),
        child: Stack(
          children: <Widget>[
            Column(
                ...
                children: [
                  SizedBox(
                    height: ((Globals.width>Globals.height) ? Globals.dwidth: Globals.dheight) * 20,
                  ),
                  Flex(
                      ...
                      Expanded(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            TextField(
                              style: TextStyle(
                                  fontSize: ((Globals.width>Globals.height) ? Globals.dwidth: Globals.dheight) * 18,
                                  color: Colors.white),
            ...
            Positioned(
                ...
                child: InkWell(
                  ...
                  child: FaIcon(FontAwesomeIcons.times,
                      color: Colors.white, size: ((Globals.width>Globals.height) ? Globals.dwidth: Globals.dheight) * 40),
                ))
          ],
        ),
      ),
