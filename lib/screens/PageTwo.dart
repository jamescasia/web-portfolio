                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      FaIcon(
                        ...
                        size: ((Globals.width>Globals.height) ? Globals.dwidth: Globals.dheight) * 80,
                        color: Globals.white,
                      ),
                      ...
                      SizedBox(height: ((Globals.width>Globals.height) ? Globals.dwidth: Globals.dheight) * 140),
                    ],
                  ),
                ),
              ),
              ...
              child: Center(
                child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        border: Border.all(
                            width: ((Globals.width>Globals.height) ? Globals.dwidth: Globals.dheight) * 0.5,
                    ...
                    child: Flex(direction: Axis.horizontal, children: [
                      Expanded(
                        ...
                        child: Container(
                          padding: EdgeInsets.symmetric(
                              horizontal: ((Globals.width>Globals.height) ? Globals.dwidth: Globals.dheight) * 60),
                              ...
                              children: [
                                ...
                                Column(
                                  children: <Widget>[
                                    ...
                                    SizedBox(height: ((Globals.width>Globals.height) ? Globals.dwidth: Globals.dheight) * 10),
                                    Text(
                      ...
                      Divider(
                          thickness: ((Globals.width>Globals.height) ? Globals.dwidth: Globals.dheight) * 0.5,
                          height: Globals.height,
                          color: Colors.grey[700]),
                      Expanded(
                        flex: 1,
